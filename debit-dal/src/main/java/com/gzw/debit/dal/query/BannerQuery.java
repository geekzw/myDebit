...
public class BannerQuery extends BaseQuery implements Serializable {
    ...
    /**
     * This class corresponds to the database table debit_banner
     */
        ...
        public Criteria andBannerOrderLike(Integer value) {
            addCriterion("banner_order like", value, "bannerOrder");
            return (Criteria) this;
        }

        public Criteria andBannerOrderNotLike(Integer value) {

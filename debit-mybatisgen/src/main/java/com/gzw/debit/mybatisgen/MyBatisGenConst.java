package com.gzw.debit.mybatisgen;
...
public class MyBatisGenConst {
    ...
    // 包名
    public static final String MAIN_PACKAGE = "com.gzw.debit.dal";
    public static final String DO_PACKAGE = "com.gzw.debit.dal.model";
    public static final String QUERY_PACKAGE="com.gzw.debit.dal.query";
    public static final String MAPPER_PACKAGE = "com.gzw.debit.dal.mapper";
    public static final String MANAGER_PACKAGE= "com.gzw.debit.core.manager";
    public static final String MANAGER_IMPL_PACKAGE= MANAGER_PACKAGE+".impl";

    public static final String MAPPER_EXT_PACKAGE = "com.gzw.debit.dal.mapper.ext";
    public static final String TABLE_PREFIX = "debit_";
    ...
    // mapper xml 输出目录
    public static final String MAPPER_XML_DIR = WORK_DIR + "debit-dal/src/main/resources/mapper/";
    // mapper-ext xml 输出目录
    public static final String MAPPER_EXT_XML_DIR = WORK_DIR + "debit-dal/src/main/resources/mapper/ext/";
    // do/model 输出目录
    public static final String MAPPER_DO_DIR = WORK_DIR + "debit-dal/src/main/java/com/gzw/debit/dal/model";
    // query 输出目录
    public static final String MAPPER_QUERY_DIR = WORK_DIR + "debit-dal/src/main/java/com/gzw/debit/dal/query";
    // mapper java 输出目录
    public static final String MAPPER_JAVA_DIR = WORK_DIR + "debit-dal/src/main/java/com/gzw/debit/dal/mapper";

    public static final String MANAGER_JAVA_DIR = WORK_DIR + "debit-core/src/main/java/com/gzw/debit/core/manager";
    public static final String MANAGER_IMPL_JAVA_DIR =  MANAGER_JAVA_DIR +"/impl";



    // mapper-ext java 输出目录
    public static final String MAPPER_EXT_JAVA_DIR = WORK_DIR + "debit-dal/src/main/java/com/gzw/debit/dal/mapper/ext";
    // java数据对象类模板
